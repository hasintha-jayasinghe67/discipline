      ...
      <div className="page-shell">
        <div className="max-w-2xl mx-auto flex flex-col gap-4 sm:gap-6">
          ...
          <div className="card-solid p-4 sm:p-6">
            ...
            {/* List title */}
            <div className="mb-5">
              <label htmlFor="list-title" className="block text-sm font-medium text-slate-700 mb-1.5">
                List Title
              </label>
              <input
                id="list-title"
            ...
            <div className="border-t border-slate-100 pt-5 mb-4">
              <p className="text-sm font-medium text-slate-700 mb-2">Add students by Admission No</p>
            ...
            <div className="border-t border-slate-100 pt-5 mb-5">
              <label htmlFor="created-by" className="block text-sm font-medium text-slate-700 mb-1.5">
                Your Name
              </label>
              <input
                id="created-by"
